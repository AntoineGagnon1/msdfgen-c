...
{
	generateSDF(PTR_TO_BITMAP(float, 1, output_r), PTR_TO_CONST_REF(Shape, shape), PTR_TO_CONST_REF(SDFTransformation, transformation), PTR_TO_CONST_REF(GeneratorConfig, config));
}
...
{
	generatePSDF(PTR_TO_BITMAP(float, 1, output_r), PTR_TO_CONST_REF(Shape, shape), PTR_TO_CONST_REF(SDFTransformation, transformation), PTR_TO_CONST_REF(GeneratorConfig, config));
}
...
{
	generateMSDF(PTR_TO_BITMAP(float, 3, output_rgb), PTR_TO_CONST_REF(Shape, shape), PTR_TO_CONST_REF(SDFTransformation, transformation), PTR_TO_CONST_REF(MSDFGeneratorConfig, config));
}
...
{
	generateMTSDF(PTR_TO_BITMAP(float, 4, output_rgba), PTR_TO_CONST_REF(Shape, shape), PTR_TO_CONST_REF(SDFTransformation, transformation), PTR_TO_CONST_REF(MSDFGeneratorConfig, config));
}
...
{
	generateSDF_legacy(PTR_TO_BITMAP(float, 1, output_r), PTR_TO_CONST_REF(Shape, shape), RANGE_CAST(range), VEC2_CAST(scale), VEC2_CAST(translate));
}
...
{
	generatePSDF_legacy(PTR_TO_BITMAP(float, 1, output_r), PTR_TO_CONST_REF(Shape, shape), RANGE_CAST(range), VEC2_CAST(scale), VEC2_CAST(translate));
}
...
{
	generatePseudoSDF_legacy(PTR_TO_BITMAP(float, 1, output_r), PTR_TO_CONST_REF(Shape, shape), RANGE_CAST(range), VEC2_CAST(scale), VEC2_CAST(translate));
}
...
{
	generateMSDF_legacy(PTR_TO_BITMAP(float, 3, output_rgb), PTR_TO_CONST_REF(Shape, shape), RANGE_CAST(range), VEC2_CAST(scale), VEC2_CAST(translate), PTR_TO_CONST_REF(ErrorCorrectionConfig, errorCorrectionConfig));
}
...
{
	generateMTSDF_legacy(PTR_TO_BITMAP(float, 4, output_rgba), PTR_TO_CONST_REF(Shape, shape), RANGE_CAST(range), VEC2_CAST(scale), VEC2_CAST(translate), PTR_TO_CONST_REF(ErrorCorrectionConfig, errorCorrectionConfig));
}
